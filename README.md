...
[![version](https://img.shields.io/badge/release-v0.4.1-lightgrey.svg)](https://github.com/tarassh/fairy-wallet/releases)
...
The latest release version is 0.4.1. To download application use one the following links:

- [for MacOS](https://github.com/tarassh/fairy-wallet/releases/download/v0.4.1/FairyWallet-0.4.1.dmg)
- [for Windows](https://github.com/tarassh/fairy-wallet/releases/download/v0.4.1/FairyWallet.Setup.0.4.1.exe)
- [for Linux](https://github.com/tarassh/fairy-wallet/releases/download/v0.4.1/fairy-wallet_0.4.1_amd64.deb)

Release notes: https://github.com/tarassh/fairy-wallet/releases/tag/v0.4.1
